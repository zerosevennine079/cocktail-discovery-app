...
import { Box, Button, Checkbox, FormControlLabel, Select, MenuItem, InputLabel, List, ListItem, ListItemText } from "@mui/material";
...
export default function DrinkFinder() {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 3, maxWidth: '1200px', margin: '0 auto', p: 4 }}>
            ...
            <Box sx={{ flex: 1, border: 1, borderRadius: 2, padding: 3, boxShadow: 2 }}>
                ...
                <Button variant="contained" color="primary" onClick={getDrinksFromIngredients} sx={{ width: '100%', mb: 2 }}>
                    Find Drinks
                </Button>
            ...
            <Box sx={{ flex: 1, border: 1, borderRadius: 2, padding: 3, boxShadow: 2 }}>
                ...
                <Button variant="contained" color="primary" onClick={getIngredientsFromDrink} sx={{ width: '100%', mb: 2 }}>
                    Get Ingredients
                </Button>
